 ...
 * 将内容回复给微信的封装方法
 */
const genInfo = function (content, fromUsername, toUsername, message) {
  var info = {};
  var type = 'text';
...
function makeCompiler() {
   ...
   * 编译过后的模版
   */
  const msg:Function = ejs.compile(tpl);
  ...
  const body:Function = ejs.compile(wrapTpl);
  return {
    msg,
    body,
    genInfo,
...
const wxCompiler:WXCompiler = makeCompiler();

module.exports = wxCompiler;
